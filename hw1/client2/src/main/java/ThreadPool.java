...
public class ThreadPool {
    ...
    private static String filePath = "/Users/junyaofeng/Desktop/result.csv";
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        for (int i = 0; i < NUMTHREADS; i++) {
            Runnable runnable = new ThreadSingle(bq, recordList, completed);
        ...
        // calculate metrics related to response time
        RecordListProcess process = new RecordListProcess(recordList);
        process.execute();

        // write to csv file
        WriteCsv writeCsv = new WriteCsv(filePath, recordList);
        writeCsv.execute();
