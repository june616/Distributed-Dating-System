...
//        System.out.println("Length of the response time list: " + length);
        System.out.println("The mean response time (millisecs): " + meanResponseTime);

        // get the median response time
        Integer medianResponseTime = getMedian(responseTimeList);
        System.out.println("The median response time (millisecs): " + medianResponseTime);

        // get the p99 (99th percentile) response time
        Integer p99ResponseTime = getPercentile(responseTimeList, 99);
        System.out.println("The p99 response time (millisecs): " + p99ResponseTime);
        ...
        System.out.println("The min response time (millisecs): " + minResponseTime);
        System.out.println("The max response time (millisecs): " + maxResponseTime);
    }
