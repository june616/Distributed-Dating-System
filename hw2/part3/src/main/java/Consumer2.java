...
public class Consumer2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException, InterruptedException {
        // key: Swiper id, value: a queue stores the most recent 100 swipees' id that had swiped right on
        ConcurrentHashMap<String, MatchData> map = new ConcurrentHashMap<>();
...
//        factory.setHost("localhost");
        ...
        for (int i = 0; i < NUM_THREADS; i++) {
            Runnable runnable = new Rec2_Single(FANOUT_EXCHANGE, QUEUE_NAME, connection, REQUEST_PER_THREAD, map, factory, countDownLatch);
